...
onMounted(async () => {
	...
	metaOGimage.setAttribute('content', 'https://luisquinterojr.com/favicon.ico');
...
.contact__c-input .contact__form-button:hover {
	color: var(--neutral-0);
